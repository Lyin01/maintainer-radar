...
`https://github.com/Lyin01/maintainer-radar`
...
```bash
python -m maintainer_radar snapshot-github Lyin01/maintainer-radar --output reports/github-snapshot.json
python -m maintainer_radar apply-pack reports/github-snapshot.json --repository-url https://github.com/Lyin01/maintainer-radar --output reports/application-pack.md
```
